...
class LeftAppearanceAnimationSpec: QuickSpec {
  ...
  override func spec() {
    describe("LeftAppearanceAnimation") {
      var animation: LeftAppearanceAnimation!
      var view: UIView!
      ...
      beforeEach {
        ...
        animation = LeftAppearanceAnimation(view: view, destination: destination, duration: 0)
      }
